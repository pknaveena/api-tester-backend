...
A web-based API testing tool inspired by applications like Postman.
...
The backend is built using **Java and Spring Boot**, with **MySQL** for data persistence and **JWT-based authentication** for securing APIs.

A React frontend is planned for the next stage of the project.
